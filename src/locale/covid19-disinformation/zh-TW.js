export const COVID19_D = {
  ...
  DESCRIPTION:
    '嚴重特殊傳染性肺炎（俗稱武漢肺炎）已經奪走 50 萬人的性命，但隨著病毒一起傳佈到世界並造成危害的，還有「假訊息」，不但跑得比病毒還快，還奪取人命，加重種族歧視的危害。READr 分析超過 5000 篇事實查核報告，洞悉假訊息全球散播的狀況與趨勢。',
  SOURCE: '來源：',
  ANNOTATION: '註：',
  CHAPTER_1: {
    P_1:
    ...
    P_3: {
      TEXT_1:
        '這半年來，除了守在第一線對抗病毒的醫護人員，也有一群人在奮力對抗著如病毒一般蔓延、「真正的假訊息」。因為它們顯然傳播得比病毒還要快，「當時（1 月下旬）病毒的傳播僅限於中國，卻已經在全球出現廣泛的假訊息。這是事實查核領域有史以來最大的合作項目。」國際事實查核組織聯盟（IFCN）查核記者曼塔斯（Harrison Mantas）曾',
      LINK: '表示',
      TEXT_2: '。'
    },
    ...
    P_5: {
      TEXT_1:
        '1 月 23 日晚上，當臺灣事實查核中心總編審陳慧敏仍埋頭工作，與 IFCN 的副總監塔達戈勒（Cristina Tardáguila）合力完成',
      LINK: '「中國逮捕武漢肺炎 8 位吹哨者了嗎」事實查核報導',
      TEXT_2:
        '——其中一位吹哨者就是後來廣為人知的李文亮——中國傳來武漢因為肺炎疫情封城的消息。'
    },
    ...
    P_9: {
      LINK: '路透社的報導',
      TEXT_1:
        '引述西班牙事實查核組織 Maldita.es 面臨的挑戰：在選舉時，他們每天平均從 WhatsApp 收到 600 個查核需求，高峰時候 900 個；但在武漢肺炎期間，每天收到的訊息是 1500 至 2000 則。'
    },
    P_10: {
      TEXT_1:
        '超過 40 個國家的事實查核員戮力工作，彷彿接力一般，一個時區的工作時間結束，就換另一個時區開始上班，他們也將查核報告即時發佈在',
      LINK: '公開的資料庫',
      TEXT_2:
        '中。READr 透過人工分析截至 5 月中旬超過 5000 篇查核報告，並深入研究前 3 名國家與臺灣的假訊息主題以及它們的影響力，發現「誇大疫情」、「誇大政府管制」與「健康類」的假訊息最多人傳播，而臺灣的假訊息趨勢又跟世界相反。'
    },
    P_11:
      '但若觀察假訊息的「影響力」，除了令人恐懼的訊息本來就容易引起共鳴，我們也發現在這波疾病大流行中，人們更傾向轉貼疫情中的「好消息」。而名人因為追隨者多，發佈的假訊息影響力也跟著提高。',
    P_12: {
      TEXT_1:
        '我們也將這超過 5000 篇查核報告以及它的影響力製成視覺化專題，你可以',
      LINK: '點擊這裡看到',
      TEXT_2: '。'
    },
    P_13:
    ...
    P_14: {
      ...
      LINK: '路透社新聞研究所',
      TEXT_2:
        '的方法，人工分類這些假訊息。發現趨勢與他們的研究大致相符，唯有「病毒在社區中的傳播」這一個類別的假訊息明顯比較多。這個分類主要闡述病毒在不同地區帶來的影響，從聲稱某個地區首次出現病例，到指責某些種族傳播病毒。以誇大疫情影響的內容居多。'
    },
    P_15:
      '由於路透社新聞研究所的樣本限於英語國家及 3 月前的假訊息。從兩份研究的樣本差異可以看見，非英語國家有比較多誇大疫情的假訊息。另外在 4 至 5 月這段期間，誇大疫情的訊息在全球數量也愈來愈多。'
  },
  CHAPTER_2: {
    ...
    QUOTE_4: {
      BOLD:
        '「一群已經感染武漢肺炎的穆斯林在清真寺裡舔著空餐盤，意圖把病毒傳給更多人。」',
      NORMAL:
        '——但這個影片在 2018 年就被上傳到網路上，舔器皿的動作是想表達對食品零浪費的信念。'
    },
    QUOTE_5: {
    ...
    QUOTE_6: {
      BOLD_1:
        '一群人在類似宗教場地用力甩頭、大口吐氣（甚至有點像打噴嚏的動作）的',
      LINK: '影片',
      BOLD_2:
        '被附註上這樣的文字：「這樣做是為了把病毒傳染到空氣中。這些人會來到你身邊，把武漢肺炎傳染給你，這是他們的新聖戰。」'
    },
    ...
    P_7: {
      ...
      LINK: '法新社的報導',
      TEXT_2:
        '，有穆斯林的家被鄰居丟石頭、工作室被縱火燒毀、卡車司機和流浪者被攻擊、攤販被暴力對待。在一件由警方核實的事件中，一名年輕的穆斯林男子被棍棒毆打到流血求饒，一位攻擊者對他說：「誰派你來傳播病毒？」'
    },
    P_8: {
      TEXT_1: '除了宗教仇恨的渲染，戈爾也提到，在印度本地的',
      LINK: '研究',
      TEXT_2:
        '中發現，除了社交媒體以外，主流媒體、政客、公眾人物都成為假訊息的散播節點，讓假訊息的危害愈來愈大。'
    }
  },
  CHAPTER_3: {
    ...
    P_3: {
      TEXT_1:
        '不只是維他命 C。在這一類別的假訊息中，還有「將駱駝奶與尿混合」、「牛糞和牛尿」、「吃肥皂」、「做愛」可以對抗武漢肺炎等等，讓人感到不可思議的訊息。起初，連事實查核員都有同感，塔達戈勒在',
      LINK: '路透社的採訪中',
      TEXT_2:
        '提到，她們收到查核「喝純酒精可以殺死武漢肺炎」的需求時，覺得十分荒謬，但幾天後，她看到數 10 名伊朗人死於喝純酒精。'
    },
    P_4: {
      TEXT_1: '根據 ABC 新聞在 3 月底的',
      LINK_1: '報導',
      TEXT_2:
        '，從伊朗 2 月出現首例武漢肺炎確診病例後，至少有 2197 人因喝到假酒而中毒，有 244 人因此身亡；路透社也曾經',
      LINK_2: '報導',
  ...
  CHAPTER_4: {
    ...
    P_5: {
      TEXT_1:
        '印度就發生「謠言填補空白」的有趣實例。戈爾分享，印度總理莫迪在演說中要求人民在 3 月 22 日實施宵禁，從週日早上 7 點到晚上 9 點都待在家，但社群媒體馬上出現一則消息說：總理要求大家這樣做，是因為病毒最多只能在表面存活 12 小時，14 小時的宵禁將打破印度大流行的感染鏈，讓印度安全——',
      LINK: '但這是錯誤的',
      TEXT_2: '，病毒可以在某些表面存活數天。'
    },
    P_6: {
      TEXT_1:
        '還有一次，總理鼓勵人們在星期日晚上 9 點一起點燃蠟燭，透過集體活動彰顯印度人民抗疫的決心。結果社群平台卻出現了「據 NASA 的研究，病毒無法在高溫下生存，如果同時點燃 130 支蠟燭，溫度將升高 9 度，病毒將在 21:09 分死亡。這是莫迪想出來的厲害方法！」——但',
      LINK: '莫迪沒有這麼說過',
      TEXT_2: '，這麼做也無法殺死病毒。'
    }
  },
  ...
  CHAPTER_6: {
    ...
    P_4: {
      ...
      LINK: '台灣民主實驗室的研究',
      TEXT_2:
        '，這類的假訊息主要出現在 1 月（也就是 IFCN 資料庫上線之前，因此不在本次 READr 研究範圍內），而且與公關公司的操作和中國資訊戰的攻擊有關。'
    },
    P_5:
  ...
  CHAPTER_8: {
    ...
    P_2: {
      TEXT_1:
        '根據事實查核組織的註記，在這些報告中，有 782 篇是在 Twitter 上散佈的假訊息。我們',
      ANNOTATION:
        '人工抓出報告中假訊息的原文（註：有些事實查核報告沒有標記原文、有些原文在 Twitter 上已經佚失，我們共找到 351 篇，佔整體 45%）',
      TEXT_2:
        '，並在 Twitter 以及政治大學鄭宇君團隊提供的 Twitter 封存推文資料中查詢它們的影響力。'
    },
    P_3:
  ...
  CHAPTER_10: {
    ...
    P_3:
      '有 57% 的共和黨人（川普所屬的政黨）相信武漢肺炎是在中國實驗室被製造出來的；<br>有 44% 的共和黨人認為一切都是比爾・蓋茲的陰謀，他將展開大規模的疫苗接種，將微芯片植入人體，來監控人類；<br>更有 41% 的川普選民表示，如果有奎寧的話，他們會服用。儘管美國疾管署警告奎寧只能在臨床試驗或醫院中使用，因為它可能導致患者致命性的心律不整。',
    P_4: {
      TEXT_1: '「你永遠無法知道人們會相信什麼。」塔達戈勒曾在接受',
      LINK: '路透社採訪時',
      TEXT_2:
        '表示。而這些事實查核報告只揭示了一部分的假訊息，那些在非公開場合發表、或是難以破案的假訊息，仍乘著人們的恐懼與焦慮持續散佈著。'
    }
  },
  CHART_1: {
    TITLE: '國際事實查核報告假訊息分佈地點前 15 名',
    ANNOTATION:
      '此數據為資料庫中查核組織自行在查核報告標註的地點，代表這則假訊息在哪些地區傳播。'
  },
  CHART_2: {
    TITLE: '武漢肺炎的假訊息都是哪些主題',
    ANNOTATION:
      'READr 參考路透社新聞研究所的研究方法，人工對樣本（n=5216）分類。同一則假訊息可能會包含一個以上的分類。每個分類的意義請見文末「研究方法」區塊。'
  },
  CHART_3: {
  ...
  CHART_10: {
    ...
    SOURCE: {
      ...
      LINK: 'IFCN 事實查核報告',
      TEXT_2:
        '中找出在 Twitter 上散佈的假訊息的原文，並參考路透社新聞研究所的研究方法人工分類。',
      ID: '2954585'
    }
  },
  CHART_11: {
  ...
  INFO_BOX: {
    ...
    P_1: {
      TEXT_1:
        '此報導的研究基礎來自國際事實查核組織針對武漢肺炎建置的事實查核報告資料庫 ',
      TEXT_2:
        '，我們擷取了 2020 年 1 月 29 日至 2020 年 5 月 12 日共 5216 篇事實查核報告，參考路透社新聞研究所的研究方法，人工替這些查核報告分類。'
    },
    P_2: {
      LINK: '路透社新聞研究所',
      TEXT_1:
        '的研究方法，將假訊息分成 9 類，READr 新增了 2 個類別（加註*），每個類別的內容如下表：'
    },
    P_3:
      '影響力部分，有 782 篇查核報告標註該報告內提到的假訊息是在 Twitter 上散佈。READr 人工抓出報告中假訊息的原文，並在 Twitter 以及政治大學鄭宇君團隊提供的 Twitter 封存推文資料中查詢它們的影響力。但由於有些事實查核報告沒有標記原文，有些原文在 Twitter 上已經佚失，我們共找到 351 篇，佔整體 45%。',
    P_4:
      '政治大學鄭宇君團隊提供的 Twitter 封存推文資料，是於 1 月 31 日至 5 月 31 日使用 Twitter Search API 收集關鍵字為 coronavirus, Wuhan, nCoV2019, 武漢肺炎, 新冠肺炎, wuhancoronavirus, wuhanvirus, covid19，僅缺 3 月 6 日的資料。資料量共 802,1949 筆。'
  },
  INFO_BOX_TABLE: {
    COLUMN_1_HEADING: '類型',
    COLUMN_2_HEADING: '解釋',
    ROW_1: {
      COLUMN_1: '官方機構的作為',
      COLUMN_2:
        '關於國家政策、國家行動、國家溝通的主張；以及 WHO建議的準則和推薦的做法等等。'
    },
    ROW_2: {
      COLUMN_1: '病毒在社區中的傳播',
      COLUMN_2:
        '關於病毒如何在國際間、國家內傳播，以及人或團體如何受到影響，從聲稱地理區域首次感染病毒的說法到指責某些種族傳播病毒的內容。'
    },
    ROW_3: {
      COLUMN_1: '醫學相關、疾病的影響',
    ...
    ROW_4: {
      COLUMN_1: '名人宣稱或相關活動',
      COLUMN_2:
        '關於政治人物、名人或藥品公司的聲明，包括聲稱哪些名人被感染，但如果錯誤訊息來自政客或其他名人，則不在此分類中）。'
    },
    ROW_5: {
      COLUMN_1: '陰謀論',
      COLUMN_2:
        '關於病毒是被用來當作生物武器，或聲稱誰是病毒的幕後黑手，或聲稱某某人／書籍／影視作品已經預言過此病毒的出現。'
    },
    ROW_6: {
      COLUMN_1: '病毒是如何傳播',
      COLUMN_2:
        '關於聲病毒的傳播方式，以及如何阻止病毒傳播，包括如何清潔、使用某些類型的器具或防護裝備等等。'
    },
    ROW_7: {
      COLUMN_1: '病毒的起源',
    ...
    ROW_8: {
      COLUMN_1: '準備與預防',
      COLUMN_2:
        '關於囤積、購買物資、以及社交距離等訊息，以及遵守或不遵守相關管制措施。'
    },
    ROW_9: {
      COLUMN_1: '疫苗研發',
      COLUMN_2: '關於疫苗的研發和進度'
    ...
    ROW_10: {
      COLUMN_1: '因為疫情衍生出的行為',
      COLUMN_2:
        '因為武漢肺炎引起的事件。如詐騙、綁架、政治鬥爭等，或是因為人類減少活動，大自然正在恢復平靜'
    },
    ROW_11: {
      COLUMN_1: '疫情其實不嚴重',
      COLUMN_2:
        '描述武漢肺炎疫情其實不嚴重。包括拿流感或其他疾病的死亡率相比，或是空蕩的醫院照片來暗示'
    }
  },
