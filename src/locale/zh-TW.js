export default {
  ...
  'FOREIGN_LABOUR_III': {
    ...
    'SECTION_4': '一名農家表示，許多來自越南、印尼的移工們「農業技能點滿」，不用花太多心思調教就能上軌道，而且印尼失聯移工多半吃苦耐勞安分怨言少，加上薪水只需本土勞工 2/3（甚至1/2）就請得起，是許多農家偏好的聘僱對象。',
    'SECTION_5': '即便是容貌相對容易辨識的印尼移工，一旦戴上帽子、斗笠和面罩後，除非走近細看，否則一時間也很難被外人辨識出來。進一步說，即便認得出來，其實農村的人們也多半已接納，甚至仰賴他們的存在，多半不願意主動檢舉。',
    ...
    'SECTION_13_6': '語畢，大家都笑了，唯獨 Andy Lau 還是維持他一貫靦腆的傻笑，無法為自己辯解。',
    'SECTION_14': '農場不只包住也包吃，冰箱裡隨時塞滿雇主準備的雞鴨魚肉和新鮮蔬果。唯一需要他們另外掏錢買的，是料理家鄉菜需要用到的石缽與香料。天黑後的台灣農村，飄的卻是異國的家鄉味。'
  }
}
