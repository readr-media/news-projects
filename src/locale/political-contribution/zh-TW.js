export const POLITICAL_CONTRIBUTION = {
  ...
  EXPLORE: {
    ...
    P: [
      ...
      '我們費了九牛二虎之力，把這些資料通通帶出來了！來看看 2008 至 2020 年的第七屆、第八屆、第九屆、第十屆區域立委候選人跟企業有什麼關係吧！'
    ]
  },
  STORY_HINT: '註',
  STORY1: {
  ...
  STORY5: {
    TITLE: '資料怎麼看？<br>政治獻金的五個發現',
    SUBTITLES: [
      '變心了！大多數的集團捐贈的政黨傾向不是鐵板一塊',
      '捐最多政治獻金的產業為批發零售業、製造業與不動產業',
      '最積極捐獻政治獻金的產業為礦業、電力燃氣業、不動產業',
      '民進黨在第九屆吸金氣勢大增，追上國民黨，但捐贈組成差很多',
      '總體收入是增加的，但營利事業影響變小？'
    ],
    P: [
      ...
      '我們改變了統計產業類別的方式，以財政部稅籍資料為主，',
      '由行業代碼對應到稅務行業分類的十九大分類',
      '。由於一間公司可能會登記多個業別',
    ...
    HINTS: [
      ...
      [
        '2016 年《經濟學人》（The Economist）發布「裙帶資本主義指數」（Crony Capitalism）',
        '報告',
        '，統計各國的億萬富豪在與政府往來密切的行業中，所獲取的財富佔 GDP 的比例。在 22 個國家中，台灣以 3.2% 排名第 10 名，高於亞洲的日本、韓國、甚至中國。指數愈高，就代表在這個國家裡有愈多的企業，商業的成功與否取決於政商關係的密切度，而這些優惠與偏袒都是合法的。他們通常會以壟斷或遊說等手段，讓政府運用行政權力，提供較好的生存環境與利益。簡單來說，就是「靠關係」賺錢。這些產業有賭場、國防、信貸投資銀行、基礎設施、管線、油、瓦斯等能源業、房地產、建設業、鋼鐵、金屬、礦石等等。'
      ]
    ]
  },
  STORY6: {
    TITLE: '政治獻金資料到底解密了什麼？',
    P: [
      'READr 政治獻金數位化專案是延續 2014 年 g0v 零時政府透過鄉民的力量數位化資料的靈感，最後成功促使政府修法，並推出官方查詢平台，未來政治獻金資料會直接公開上網。'
    ],
    LEGEND: '政府相關回應或作為'
  }
}
