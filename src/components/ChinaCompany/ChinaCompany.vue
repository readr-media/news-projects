  ...
  metaInfo () {
    return {
      ...
      customScript: `
        ...
        <div id="fb-root"><\/div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/zh_TW/sdk.js#xfbml=1&version=v3.3&appId=175313259598308&autoLogAppEvents=1"><\/script>
      `
    }
  },
  components: {
