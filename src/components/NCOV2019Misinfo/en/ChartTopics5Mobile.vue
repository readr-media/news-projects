  ...
  export default {
    ...
    data() {
      return {
        ...
        //   },
        //   {
        //     topic: ['Other incidents caused by COVID-19'],
    ...
    async mounted() {
      ...
      const data = this._dataCSV.filter(d => ['Other incidents caused by COVID-19'].includes(d.topics))
      ...
      // wrapper.append('g').call(yAxis)
       ...
       this._y = d3.scaleBand().domain(['Other incidents caused by COVID-19']).range([0, noSplitHeight])
       const y = this._y
      ...
      wrapper
        ...
        .attr('x', innerWidth / 2)
        .attr('y', d => y('Other incidents caused by COVID-19') + y.bandwidth() / 2 - 70)
        .style('font-size', '16px')
        .text('Other incidents caused by COVID-19')
