  ...
  <section class="standalone opinion">
    ...
    <div class="chapter--header">
      <div class="header--content">
        <div class="centerwpr">
          <h2>農舍面面觀</h2>
          <p>看完了這麼多的數據、分析和照片，或許您在想 - 那麼在地宜蘭人、農民、官員又是怎麼想的呢？以下，我們特別專訪了宜蘭的房仲、老農、代耕農、農田水利會長、農委會副主委，各自從他們的角度來審視農舍議題。或許，您看完之後，會對農舍有更全面而立體的了解，下次到了宜蘭看見四野繁盛綻放的農舍時，心裡也會有不同的感受呢。</p>
        </div>
      </div>
    </div>
