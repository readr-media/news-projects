export const originEvents = [
  ...
  {
    isByGovernment: true,
    date: '2014 年 12 月 10 日',
    title: '立法院排案審議《政治獻金法》',
    listItems: [
      '資訊公開部分，一讀通過李應元版本條文（所有收支明細都應公開上網），但直至會期結束都沒有新進度',
      '行政院當時的修正草案，只要求「公司團體捐款超過 50 萬」的明細上網公開',
      '立委陳其邁、李應元（現為環保署署長）版本皆主張所有收支明細全部公開',
      '立委李昆澤除主張所有收支明細全部公開外，還在明訂公開資訊「須採便利民眾複製、下載的格式」',
    ]
  },
]
...
export const actionEvents = [
  {
    isByGovernment: false,
    date: '2017 年 6 月 30 日',
    title: '鏡週刊程式設計中心團隊決定重啟 g0v 專案',
    listItems: [
      '至監察院印出第九屆立委營利事業政治獻金',
    ]
  },
  ...
  },
  {
    ...
    listItems: [
      ...
      {
        content: '後續社群與媒體陸續使用此資料有不同的應用',
        linkType: 'openRelatedLightbox'
      }
    ],
  },
  {
  ...
  {
    isByGovernment: false,
    date: '2017 年 12 月 18 日',
    title: '跟 g0v 參與者 RonnyWang 討論合作專案設計',
  },
  {
    isByGovernment: false,
  ...
  },
  {
    isByGovernment: false,
    date: '2018 年 2 月 9 日',
    title: '從 RonnyWang 那邊接手社群完成的資料',
  },
  {
    isByGovernment: false,
    date: '2018 年 2 月 27 日',
    title: '發現少了 10 幾位立委的資料，再度前往監察院印並採人工（打字）辨識',
  },
  {
    isByGovernment: false,
    date: '2018 年 3 月 8 日',
