<template>
  <div class="energy-policy">
    <Logo
      class="energy-policy__logo no-sprite"
    ...
    />
    <Share
      :shareUrl="`${READR_SITE_URL}energy-policy`"
      class="energy-policy__share"
      top="10px"
      right="10px"
      direction="down"
    />
    <div id="fullpage" ref="fullpage">
      ...
      <section class="section fp-noscroll">
        <div class="foreword container">
          <div>
            ...
            <p>
              2018
              年末的公民投票，讓「能源議題」從國會進到千家萬戶。由於「電」的問題直接影響民生，臺大風險中心在公投前抽樣的民調顯示，有超過八成的民眾關心能源政策發展。透過
              READr 的小測驗，來看看你的想法跟哪個總統最接近！
            </p>
            <p>
              背負能源轉型的責任，蔡英文政府卻面臨困境。距離小英 2020
              年爭取連任的投票日剩不到 365
              天，一起來看看她的能源政策推行得如何。
            </p>
      ...
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <ul>
            ...
            <li>回應臺灣社會對空污、生態環境永續的呼聲</li>
            <li>回應各國受到極端天氣衝擊，開始降低碳排放的世界潮流</li>
            <li>跟上世界發展綠能產業鏈，讓產業及鄉鎮轉型</li>
          </ul>
          <p>
        ...
        <div class="article container">
          ...
          <div class="timeline">
            ...
            <div class="event">
              <p>2018-04-01</p>
              <p>電價漲 3%</p>
              <p>電價 4 年半來首度調漲，未過門檻的小度數住戶與商家電價不會漲</p>
            </div>
            <div class="event">
              <p>2018-10-08</p>
              <p>觀塘三接案環評通過</p>
            ...
            <div class="event">
              <p>2018-11-24</p>
              <p>能源議題公投通過，非核家園條款失效</p>
              <p>
                反空污（第 7 案）、反燃煤電廠（第 8
                案）、廢除《電業法》非核家園條文（第 16
                案）公投通過，《電業法》中規定 2025
                非核家園的條款失效。火力發電每年要減少 1%
                並不再新建擴建燃煤電廠，政府因此需重新調整能源政策
              </p>
            </div>
            <div class="event">
              <p>2019-01-19</p>
              <p>躉購價爭議，離岸風電廠商停工</p>
              <p>
                因 2019 年預告的躉購電價比去年大降
                12.7%，考量成本，外商沃旭能源停止執行與臺灣廠商的合約，引發風電外商是否「棄臺」的擔憂，也有人認為政府不該花鉅額向外商買電
              </p>
            </div>
            <div class="event">
              <p>2019-03-04</p>
              <p>經濟部提出新能源配比</p>
              <p>
                因應公投結果與電源開發計畫，政府提出新的 2025 能源配比：燃氣
                50%、燃煤 27%、再生能源 20%、核電 1%、燃油和抽蓄水力也各 1%
              </p>
            </div>
          </div>
        </div>
      ...
      <section class="section fp-noscroll">
        <div class="article container">
          <h2>與現況大不同的能源轉型目標</h2>
          <p>
            蔡政府在 2017 宣佈能源轉型目標，2019
            年初經過修正，但不管是原版還是修正版，與發電現況相比都有很大不同：
          </p>
          <figure>
            <img
              class="lazy"
              data-img="/proj-assets/energy-policy/chart-3.png"
              src=""
              alt="臺灣發電結構的現況與未來"
            />
          </figure>
      ...
      <section class="section fp-noscroll">
        <div class="article container">
          ...
          <p>
            蔡政府原先規劃的 2025 年能源配比為：再生能源發電量 20%、天然氣
            50%、燃煤 30%，因應去年底的公投民意，經濟部在 2019 年 3
            月微調成核能、燃油、抽蓄水力各 1%，燃煤 27%。
          </p>
          <p>
            經濟部重申「非核家園」目標不變——2025 年 5
            月最後一座核電廠執照到期後不再延役，確定核電將走入歷史，但長期的能源配比究竟為何，經濟部還在研議。
          </p>
          <ReadMoreButton
            class="btn-readmore"
            type="open"
            @click="openReadMoreHandler(2)"
          >
            <template v-slot:moreText>
      ...
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <ul>
            <li>落實綠電先行（修正《再生能源發展條例》）</li>
            <li>
              修法開始初步電力自由化，終結台電壟斷電力市場（修正《電業法》）
            </li>
            <li>將「核電歸零」明確時間點寫入法條</li>
            <li>
              檢討《環境影響評估法》對能源相關開發案的限制，兼顧保育與發展
            </li>
          </ul>
          <p class="highlight">確保開發新能源時不缺電：</p>
          <ul>
            <li>訂定再生能源階段性發展目標</li>
            <li>要求台電加強建置智慧電網和儲能設備</li>
            <li>加強維護發電設施，確保緊急時刻有足夠的機組可以供電</li>
          </ul>
        </div>
      </section>
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <ul>
            <li>
              再生能源成本高，加上分攤擴建燃氣、封存核四的成本，未來電價會漲 20%
              至 30%
            </li>
            <li class="no-style">
              <span>蔡政府回應</span>：2025 年前電價可能會上漲，但不一定漲足
              30%，要視該年能源成本而定，且已設下 3%
              的電價漲跌幅上限，保證電價不因能源轉型而大漲
            </li>
            <li>大幅提高發電不穩定的再生能源比例，會有缺電危機</li>
            <li class="no-style">
              <span>學者指出</span>：相較於電價，臺灣居高不下的用電量更應該擔心
            </li>
            <li class="no-style">
              <span>蔡政府回應</span
              >：為了節能，推動讓民眾能直接看到用電量的智慧電表普及化
            </li>
          </ul>
          <p>
          ...
          <ReadMoreButton
            class="btn-readmore"
            type="open"
            @click="openReadMoreHandler(3)"
          >
            <template v-slot:moreText>
              <span>燃料和發電成本造成電價波動</span>
            </template>
          </ReadMoreButton>
        </div>
      </section>
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <ul>
            <li>加強智慧電網、儲能設施、電網調度，經由調節提高供電穩定性</li>
            <li>提升對風、陽光的預報能力</li>
          </ul>
          <p class="highlight">綠能很貴</p>
          <ul>
            <li>
          ...
          <p class="highlight">綠能裝置土地有限且影響生態環境</p>
          <ul>
            <li>
      ...
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <figure>
            <img
              class="lazy"
              data-img="/proj-assets/energy-policy/chart-5.png"
              src=""
              alt="臺灣再生能源裝置容量現況與目標"
            />
          </figure>
      ...
      <section class="section fp-noscroll">
        <div class="article container">
          ...
          <p>
            臺灣自 2000 年開始補助政府單位及民間設置太陽光電設施，2009
            年《再生能源發展條例》確立台電以 20
            年為期，以固定優惠價格收購綠電的「躉購制度」後，裝置容量才開始明顯快速上升，蔡英文上台後，推動「太陽光電
            2 年推動計畫」，2016 年至 2017 年的裝置容量成長率達 42%。
          </p>
          <figure>
            <img
              v-if="$store.state.viewport[0] > 768"
              class="lazy"
      ...
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <figure>
            <img
              class="lazy"
              data-img="/proj-assets/energy-policy/chart-7.png"
              src=""
              alt="太陽光電裝置容量現況與目標"
            />
          </figure>
      ...
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <figure>
            <img
              class="lazy"
              data-img="/proj-assets/energy-policy/chart-8.png"
              src=""
              alt="2014 年以來風力發電裝置容量與目標容量"
            />
          </figure>
          <ReadMoreButton
            class="btn-readmore"
            type="open"
            @click="openReadMoreHandler(5)"
          >
            <template v-slot:moreText>
      ...
      <section class="section fp-noscroll">
        <div class="article photo container">
          ...
          <figure>
            <img
              class="lazy"
              data-img="/proj-assets/energy-policy/chart-9.png"
              src=""
              alt="燃氣配比要在 2025 年前大幅提升"
            />
          </figure>
          <ReadMoreButton
            class="btn-readmore"
            type="open"
            @click="openReadMoreHandler(6)"
          >
            <template v-slot:moreText>
      ...
      <section class="section normal-scroll">
        <div class="other container">
          <div class="credit">
            <img
              class="lazy"
              data-img="/proj-assets/logo_mm_white.png"
              src=""
              alt="鏡傳媒"
            />
            <p>
              <span>文字：劉子維</span><span>設計：陳怡蒨</span
              ><span>工程：HY Tan</span>
            </p>
...
const loadImage = (index) => {
  const lazyImage = document.querySelector(
    `.section:nth-child(${index + 1}) img.lazy`
  )
  if (lazyImage) {
...
export default {
  ...
  metaInfo() {
    return {
      title: '小英來電嗎——能源轉型怎麼做？',
      description:
        '蔡英文政府力拚 2025 年能源轉型——要實現非核、提升燃氣與綠能，小英能源政策的理想遇到哪些現實阻礙？',
  ...
  methods: {
      ...
      $(document).ready(() => {
        ...
        $('#fullpage').fullpage({
          ...
          onLeave(index, nextIndex, direction) {
            ...
            if (nextIndex > max) {
              max += 1
              ga('send', 'event', 'projects', 'scroll', `move to ${max}`, {
    ...
    moveTo(sectionIndex) {
      ...
      ga('send', 'event', 'projects', 'click', `move to ${sectionIndex}`, {
        nonInteraction: false
      })
    },
    openReadMoreHandler(index) {
      ...
      ga('send', 'event', 'projects', 'click', `read more ${index}`, {
        nonInteraction: false
      })
    }
  }
...
.energy-policy
  ...
  .section
    ...
    &:nth-of-type(8)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-2.jpg)
    &:nth-of-type(9)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-3.jpg)
    &:nth-of-type(10)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-4.jpg)
    &:nth-of-type(11)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-5.jpg)
    &:nth-of-type(13)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-6.jpg)
    &:nth-of-type(14)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-7.jpg)
    &:nth-of-type(15)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-8.jpg)
    &:nth-of-type(16)
      background-image linear-gradient(to right, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .5) 60%, rgba(0, 0, 0, 0) 100%), url(/proj-assets/energy-policy/bg-9.jpg)
