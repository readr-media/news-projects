...
export const READ_MORE_CONTENT = [
  {
    index: 4,
    contents: `
      <p>蔡英文在<a>選前承諾</a>：「打造一個不缺電、安全又乾淨的永續台灣。」執政後確立能源轉型三大方向：「<a>非核家園</a>、<a>穩定供電</a>、<a>空污改善</a>。」積極推動能源轉型，但臺灣能源部落格版主陳立誠質疑能源轉型的必要性，他對 READr 指出，臺灣廢核、發展綠能、降低燃煤發展燃氣的能源政策是走德國的路，政府高調倡議綠能的優點，卻不提德國電價是臺灣的四倍，「台灣現在被環保團體這些不懂得電、不懂得錢的人害死！」</p>
      <p>陳立誠計算，使用蔡政府的能源規劃，臺灣每人每年電價約漲一萬元，即使政府承諾確保民生用電不要大幅調漲，工業商業用電增加的成本也會反映到民生物價上，而且臺灣寸土寸金，不適合需要大片土地來設置發電設施的綠電。</p>
      <p>陳立誠認為，使用便宜且穩定的燃煤及核能，確保供電及物價穩定，才是臺灣能源政策該走的路。</p>
    `
  }
]
