    ...
    <div class="ending-page__container">
      ...
      <div class="ending-page__wrapper" id="ending-page__wrapper--linyi">
        <div class="ending-page__pictures">
          ...
          <picture class="ending-page__pictures__title">
            <img src="/proj-assets/backtoformosa/img/scene3/ending-linyi-title.svg" alt="">
          </picture>
        </div>
        <div class="ending-page__content mxw-400 r-40">
      ...
      <div class="ending-page__wrapper" id="ending-page__wrapper--chen">
        <div class="ending-page__pictures">
          ...
          <picture class="ending-page__pictures__title">
            <img src="/proj-assets/backtoformosa/img/scene3/ending-chen-title.svg" alt="">
          </picture>
        </div>
        <div class="ending-page__content mxw-400 r-40">
      ...
      <div class="ending-page__wrapper" id="ending-page__wrapper--linhong">
        <div class="ending-page__pictures">
          ...
          <picture class="ending-page__pictures__title">
            <img src="/proj-assets/backtoformosa/img/scene3/ending-linhong-title.svg" alt="">
          </picture>
        </div>
        <div class="ending-page__content mxw-290 r-40">
      ...
      <div class="ending-page__wrapper" id="ending-page__wrapper--huang">
        <div class="ending-page__pictures">
          ...
          <picture class="ending-page__pictures__title">
            <img src="/proj-assets/backtoformosa/img/scene3/ending-huang-title.svg" alt="">
          </picture>
        </div>
        <div class="ending-page__content mxw-290 r-40">
      ...
      <div class="ending-page__wrapper" id="ending-page__wrapper--zhang">
        <div class="ending-page__pictures">
          ...
          <picture class="ending-page__pictures__title">
            <img src="/proj-assets/backtoformosa/img/scene3/ending-zhang-title.svg" alt="">
          </picture>
        </div>
        <div class="ending-page__content mxw-290 r-40">
