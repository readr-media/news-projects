  ...
  <div>
    ...
    <main ref="main">
      <BaseContent>
        ...
        <p>南方澳跨港大橋於 1996 年開工興建、1998 年即完工，為亞洲第一座雙叉式單拱橋。在非天災衝擊當下發生斷裂事故，引發社會譁然。交通部針對南方澳大橋斷裂事件進行專題報告時指出，依據目前所獲相關資訊，初步判斷應為拱橋西側約 5 至 6 根預力吊索斷裂引起（吊索共 13 支）。該吊索均有塑料套管保護以避免鏽蝕，橋墩無鬆脫或掏空現象發生。</p>
      </BaseContent>
      ...
      <BaseContent>
        <p>宜蘭縣政府交通處養護工程科長翁鄭啟志說，當時省政府責成基隆港務局負責興建，因不具土木專業，出資由宜蘭縣政府代辦工程設計、建造與發包施工。宜蘭縣政府於完工後就將橋梁移交回基隆港務局；2012 年 3 月 1 日，港務局民營化，政企分離後，港務局蛻變為台灣港務公司，專管經營，至於航務等管理，則隸屬航港局。</p>
      ...
      <TwoImgs prefixSrc1="/proj-assets/nanfangao-bridge/img/two-1" prefixSrc2="/proj-assets/nanfangao-bridge/img/two-2">斷裂的南方澳跨港大橋現在仍尚待修復中。</TwoImgs>
      ...
      <BaseContent>
        ...
        <p>根據統計，公路總局至 2018 年止，轄下管理的橋梁就有將近 4000 座。於養護而言是極為沉重的負擔。近年運研所為修正橋梁管理制度，多次召開討論會議，席中所有單位的共同心聲是：檢測經費過少。</p>
      ...
      <FullImg prefixSrc="/proj-assets/nanfangao-bridge/img/full" />
    </main>
    <footer ref="footer">
      <TheCredit />
      <TheSubscr />
