<template>
  <div>
    ...
    <main>
      <BaseContent>
        <p class="base-content__date">2019 / 10 / 14</p>
      ...
      <div class="chart chart--three-steps">
        <img loading="lazy" :src="`/proj-assets/nanfangao-bridge/img/chart/three-steps-${threeStepsImgSize}.png`" alt="">
      </div>
      ...
      <BaseContent>
        ...
        <BaseHighcharts style="height: 316px;">
          <iframe class="highcharts-iframe" src="https://cloud.highcharts.com/embed/ufYKfS7l/" style="border: 0; width: 100%; height: 100%;"></iframe>
        </BaseHighcharts>
      ...
      <BaseContent>
        ...
        <BaseHighcharts style="height: 416px;">
          <iframe class="highcharts-iframe" src="https://cloud.highcharts.com/embed/FnlaMMid/" style="border: 0; width: 100%; height: 100%;"></iframe>
        </BaseHighcharts>
...
export default {
  ...
  mounted () {
    ...
    this.wEl.addEventListener('resize', this.alterWW)
    this.wEl.addEventListener('orientationChange', this.alterWW)
  },
  computed: {
    threeStepsImgSize () {
